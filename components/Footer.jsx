      ...
      <div className="relative w-full rounded-t-3xl overflow-hidden bg-gradient-to-br from-[#B03A08] via-[#C94D12] to-[#DD6017]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8 lg:px-10 py-10 lg:py-14">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] gap-8 lg:gap-6">
            ...
            >
              <div className="inline-block bg-white rounded-lg px-5 py-2 shadow-sm">
                <span className="font-heading font-bold text-[16px] tracking-wider text-[#FF6B00]">
                  LOGO
                </span>
              </div>
              ...
              <div className="mt-5 flex items-center gap-2">
                {socials.map((s, i) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-9 h-9 rounded-md overflow-hidden shadow-sm block"
                  >
                    <Image
                      src={s.src}
                      alt={s.alt}
              ...
              <ul className="space-y-3">
                {contacts.map((c, i) => (
                  <li key={i} className="flex items-start gap-2.5">
                    <span className="shrink-0 mt-0.5 w-5 h-5 overflow-hidden">
                      <Image
                        src={c.src}
                        alt={c.alt}
                        width={20}
                    ...
                    <span className="text-[12.5px] text-white/85 leading-[1.5] whitespace-pre-line">
                      {c.text}
                    </span>
                  </li>
                ))}
